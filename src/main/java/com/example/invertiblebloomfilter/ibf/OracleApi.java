...
import static com.example.invertiblebloomfilter.ibf.Constants.*;
import static com.example.invertiblebloomfilter.ibf.OracleErrorCode.NUMERIC_OVERFLOW;
import static com.example.invertiblebloomfilter.ibf.OracleErrorCode.ORA_08181;
import static com.example.invertiblebloomfilter.ibf.RowUtils.doubleQuote;
import static com.example.invertiblebloomfilter.ibf.RowUtils.singleQuote;
import static com.example.invertiblebloomfilter.ibf.SqlUtil.buildSchemaFilter;
import static com.example.invertiblebloomfilter.ibf.SqlUtil.scnXHoursBeforeScn;
import static com.example.invertiblebloomfilter.ibf.Transactions.hasDbaSegmentsAccess;
import static com.example.invertiblebloomfilter.ibf.Util.convertToKeyType;
...
//        @Language("SQL")
        ...
        Transactions.RetryFunction<Instant> action =
                (connection) -> {
                    try (PreparedStatement statement = connection.prepareStatement(query)) {
...
//        @Language("SQL")
        ...
        Transactions.RetryFunction<Map<TableRef, HashSet<String>>> action =
                (connection) -> {
...
//        @Language("SQL")
        ...
        Transactions.RetryFunction<Map<String, ColumnConfigInformation>> action =
                (connection) -> {
                    try (Statement selectColumns = connection.createStatement();
...
//        @Language("SQL")
        ...
        Transactions.RetryFunction<Map<TableRef, List<OracleColumn>>> action =
                (connection) -> {
...
//        @Language("SQL")
    ...
    public long mostRecentScn() {
        Transactions.RetryFunction<Long> action = (connection) -> new LogMinerSession(connection).getArchivedLogDao().getEndScn();
