...
public class TableDefinition {
    ...
    public static Builder prepareTableDefinition(TableRef table, List<Column> knownTypes) {
        ...
        Builder tableBuilder = TableDefinition.create(table);
    ...
    public static Builder create(Class<?> beanClass, String schema) {
    ...
    public static Builder create(Class<?> beanClass, String tableName, String schemaName) {
     ...
     *     definition.
     * @return A {@link Builder} instance with initialised primary keys, delete keys, foreign keys,
     *     known types etc.
     */
    public static Builder create(TableRef tableRef, Class<?> beanClass) {
    ...
    public static Builder create(TableRef table) {
...
//        }
        ...
        /**
         * Specifies a column is JSON. {@link Builder#inferJson()} is simpler and preferred; you should
