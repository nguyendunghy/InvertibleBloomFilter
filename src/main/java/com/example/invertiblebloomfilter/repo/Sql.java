...
public class Sql {
    ...
    public static String SAVE_CELL_QUERY = "INSERT INTO CELL(ID, IBF_ID,CELL_INDEX,ROW_HASH_SUM,KEY_SUM,COUNT) VALUES (?, ?, ?, ?, ?, ?)";
    public static String GET_MAX_CELL_ID_QUERY = "SELECT MAX(ID) FROM CELL";
    public static String RETRIEVE_CELL_BY_IBF_ID_QUERY = "SELECT ID,IBF_ID,CELL_INDEX,ROW_HASH_SUM,KEY_SUM,COUNT FROM IBF WHERE ID = ?";
